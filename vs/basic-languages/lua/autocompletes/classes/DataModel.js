	...
	exports.autocompletes = {
		...
		Method: {
			...
			'GetService()': {
				...
				documentation: {
					value: [
						'```lua', 'function GetService(serviceName: string)', '```',
						'',
						'Returns the service of the specified class. If the service does not exist, it will be created.',
						'',
						'[View documentation](https://developer.roblox.com/en-us/api-reference/function/DataModel/GetService)',
					].join('\n')
				},
			},
