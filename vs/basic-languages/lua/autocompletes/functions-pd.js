define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		"Function": {
			...
			"getthreadscript()": {
				"insertText": "getthreadscript(${1:thrd})",
				"documentation": { "value": "```lua\nfunction getthreadscript(thrd: thread)\n  -> LocalScript | ModuleScript\n```\nReturns the LocalScript or ModuleScript instance that the given thread originated from." }
			},
			"islocalsourcecontainer()": {
				"insertText": "islocalsourcecontainer(${1:obj})",
				"documentation": { "value": "```lua\nfunction islocalsourcecontainer(obj: Instance)\n  -> boolean\n```\nChecks if obj is a local source container (like a LocalScript)." }
			},
			"setclosureidentity()": {
				"insertText": "setclosureidentity(${1:fn}, ${2:identity})",
				"documentation": { "value": "```lua\nfunction setclosureidentity(fn: function, identity: number)\n```\nSets the security identity of a function closure." }
			},
			...
			"rconsoleclear()": {
				"insertText": "rconsoleclear()",
				"documentation": { "value": "Clears all text from the console." }
			},
			"rconsoleclose()": {
				"insertText": "rconsoleclose()",
				"documentation": { "value": "Closes the console." }
			},
			"rconsolecreate()": {
				"insertText": "rconsolecreate()",
				"documentation": { "value": "Creates a new console window." }
			},
			"rconsoledebug()": {
				"insertText": "rconsoledebug(${1:text})",
				"documentation": { "value": "Prints a debug message to the console." }
			},
			"rconsoleerr()": {
				"insertText": "rconsoleerr(${1:text})",
				"documentation": { "value": "Prints text into the console with [ERROR]." }
			},
			"rconsoleinfo()": {
				"insertText": "rconsoleinfo(${1:text})",
				"documentation": { "value": "Prints text into the console with [INFO]." }
			},
			"rconsoleinput()": {
				"insertText": "rconsoleinput()",
				"documentation": { "value": "Yields and returns user input from console." }
			},
			"rconsolename()": {
				"insertText": "rconsolename(${1:title})",
				"documentation": { "value": "Sets the console's title." }
			},
			"rconsoleprint()": {
				"insertText": "rconsoleprint(${1:text})",
				"documentation": { "value": "Prints text into the console." }
			},
			"rconsolewarn()": {
				"insertText": "rconsolewarn(${1:text})",
				"documentation": { "value": "Prints a warning to the console." }
			},
			"printconsole()": {
				"insertText": "printconsole(${1:message}, ${2:red}, ${3:green}, ${4:blue})",
				"documentation": { "value": "Prints message into the integrated console with RGB value." }
			},
			...
			"isrbxactive()": {
				"insertText": "isrbxactive()",
				"documentation": { "value": "Returns true if the game window is in focus." }
			},
			"keytap()": {
				"insertText": "keytap(${1:keycode})",
				"documentation": { "value": "Simulates a single press and release of the specified keycode." }
			},
			"mousemoverel()": {
				"insertText": "mousemoverel(${1:x}, ${2:y})",
				"documentation": { "value": "Moves the mouse cursor relatively to the current position." }
			},
			"mousemoveabs()": {
				"insertText": "mousemoveabs(${1:x}, ${2:y})",
				"documentation": { "value": "Moves the mouse cursor to absolute coordinates." }
			},
		},
	};
});